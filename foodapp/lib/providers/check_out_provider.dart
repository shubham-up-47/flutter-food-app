...
class CheckoutProvider with ChangeNotifier {
  ...
  late LocationData? setLoaction = null;
  ...
  getDeliveryAddressData() async {
    ...
    DocumentSnapshot _db = await FirebaseFirestore.instance.collection("AddDeliverAddress").doc(FirebaseAuth.instance.currentUser?.uid).get();
    if(_db.exists){
      deliveryAddressModel = DeliveryAddressModel(
...
////// Order //////
  ...
  addPlaceOrderData({
    ...
    FirebaseFirestore.instance.collection("Order").doc(FirebaseAuth.instance.currentUser?.uid).collection("MyOrders").doc().set({
      "subTotal": "1234",
      "Shipping Charge": "",
      "Discount": "10",
      "orderItems": oderItemList.map((e) => {
